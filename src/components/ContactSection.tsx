      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          >
            Let us Build
            <br />
            <span style={{ color: "#D4AF37" }} className="gold-glow">Something Real</span>
          </h2>
          <p className="max-w-xl mx-auto text-sm mb-10" style={{ color: "#E1E1E1", fontFamily: "var(--font-merriweather)", fontWeight: 300, lineHeight: "1.8" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
            <motion.a
              ...
              className="glass-card flex items-center gap-4 justify-center"
              style={{ display: "flex", flexDirection: "column", alignItems: "center", cursor: "none" }}
              whileHover={{ y: -4 }}
            >
              <Mail size={24} style={{ color: "#D4AF37" }} />
              <p className="text-sm tracking-wider uppercase" style={{ fontFamily: "var(--font-playfair)", fontWeight: 700, color: "#F5F5F5" }}>
                Email
              </p>
          ...
          <a href="mailto:kareem@mtmediaai.com?subject=From%20the%20Chronicles" className="glass-btn-gold inline-block">
